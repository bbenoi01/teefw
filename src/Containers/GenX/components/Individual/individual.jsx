    ...
    render() {
        return (
            <div className="card-body">
                ...
                <div className="card">
                    <div className="card-body text-left">
                        <p><b>3. </b>Enter ESN in search box and click Submit</p>
                        <img src="gx2.PNG" alt="config" width='100%'/>
                        <div className="form-check right">
                ...
                <div className="card">
                    <div className="card-body text-left">
                        <p><b>4. </b>Put a check mark next to ESN,make note of current primary, secondary, third config and click Configure Devices</p>
                        <img src="gx3.PNG" alt="enter config" width='100%'/>
                        <div className="form-check right">
                ...
                <div className="card">
                    <div className="card-body text-left">
                        ...
                        <img src="gx4.PNG" alt="selected esn" width='100%'/>
                        <div className="form-check right">
                ...
                <div className="card">
                    <div className="card-body text-left">
                        ...
                        <img src="gx5.PNG" alt="continue" width='100%'/>
                        <div className="form-check right">
                ...
                <div className="card">
                    <div className="card-body text-left">
                        ...
                        <img src="gx11.PNG" alt="SMS" width='100%'/>
                        <div className="form-check right">
